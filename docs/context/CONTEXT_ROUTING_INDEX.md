...
- `docs/context/ACTIVE_PREFREEZE_OPTIMIZATION_PACKET.md` - current Step 20.5
  active packet.
- `docs/context/CONTEXT_ROUTING_INDEX.md` - optional targeted lookup index.

## Routes

- Pre-freeze optimization: `docs/context/ACTIVE_PREFREEZE_OPTIMIZATION_PACKET.md`
  - current allowed/forbidden scope and focused checks.
