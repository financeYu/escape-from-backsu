...
from research_ingestion.config import get_query_set, get_source_config, load_research_config, load_toml, validate_pdf_policy, validate_policy
...
def test_config_loading_from_project_root():
    ...
    assert get_query_set(config, "technical_momentum")["queries"]
