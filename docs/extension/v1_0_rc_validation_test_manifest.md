...
|---|---|---|---|
| .venv\Scripts\python.exe -m pytest -q tests/validation/test_v1_0_rc_freeze_readiness.py | 25 passed | True |  |
| .venv\Scripts\python.exe -m pytest -q tests/validation | 177 passed | True |  |
...
| .venv\Scripts\python.exe -m pytest -q tests/backtest | 173 passed | True |  |
