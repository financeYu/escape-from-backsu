...
10. Report gate endings as `COMPLETE`, `PARTIALLY COMPLETE`, or `NEEDS FIX`; run `.agents/skills/quant-review-gate/SKILL.md` before accepting completion, and use `.agents/skills/quant-git-finalize/SKILL.md` only after review gate `PASS`; do not commit before required validation/review is complete.
