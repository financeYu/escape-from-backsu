...
This research agent is part of the `Quant_mvp` agent system and lives at:
...
- The research agent is explicitly integrated under `Quant_mvp/agents/research/AGENTS.md`.
...
python -m research_ingestion import-scholar-citation-export \
  --format bibtex \
...
python -m research_ingestion import-scholar-title-list \
  --input-dir data/research/discovery/google_scholar/title_lists \
  --run-id 20260424_000000
