...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--task", required=True, help="Context task type, for example step19_pipeline.")
    parser.add_argument("--step", required=True, help="Roadmap Step label.")
    parser.add_argument("--stage", required=True, help="Current stage label.")
    parser.add_argument(
        "--output",
        help="Output packet path. Defaults to docs/context/generated/<task>_packet.md.",
    )
    ...
    try:
        result = write_context_packet(config)
