...
|---|---|---|---|
| .venv\Scripts\python.exe -m pytest -q tests/validation/test_v1_0_rc_freeze_readiness.py | 27 passed | True |  |
| .venv\Scripts\python.exe -m pytest -q tests/validation | 179 passed | True |  |
