...
| report review | `docs/context/MVP_V0_1_BASELINE.md`, `docs/context/domain/report_context.md`; historical Step 16 report/backtest-boundary docs only via `docs/context/ARCHIVE_INDEX.md` when provenance or regression evidence is needed | on-demand review |
| valuation boundary review | `docs/context/MVP_V0_1_BASELINE.md`, `docs/context/domain/valuation_context.md`; historical Step 18 valuation-boundary docs only via `docs/context/ARCHIVE_INDEX.md` when provenance or regression evidence is needed | on-demand review |
