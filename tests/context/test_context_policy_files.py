...
def test_active_prefreeze_packet_does_not_embed_long_step_history() -> None:
    text = (ROOT / "docs/context/ACTIVE_PREFREEZE_OPTIMIZATION_PACKET.md").read_text(encoding="utf-8")
